...
import id.fp.fintech.ui.coindetails.CoinDetailsActivity
...
open class BaseFragment : Fragment() {
    ...
    fun openCoinDetailsActivity(coin: Coin) {
    ...
    fun openExchangeDetailsActivity(exchange: Exchange) {
        startActivity(
                Intent(
                        Intent.ACTION_VIEW,
